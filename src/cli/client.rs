...
impl InsightsClient {
    ...
    pub async fn add_insight(
        ...
        self.post_json::<AddInsightRequest, ()>("/insights/add", &request)
            .await
    }
    ...
    pub async fn update_insight(
        ...
        self.put_json::<UpdateInsightRequest, ()>("/insights/update", &request)
            .await
    }
    ...
    pub async fn list_insights(
        &self,
        _filters: Vec<InsightFilter>,
    ) -> Result<ListInsightsResponse> {
    ...
    pub async fn get_logs(
        ...
        let response = self
            .execute_with_timeout(|| self.client.get(&url).send())
            .await?;
...
impl InsightsClient {
    ...
    {
        timeout(Duration::from_secs(self.config.timeout_secs), request_fn())
            .await?
            .map_err(Into::into)
    }
        ...
        R: serde::de::DeserializeOwned,
    {
        ...
        let response = self
            .execute_with_timeout(|| self.client.post(&url).json(request).send())
            .await?;
        ...
        R: serde::de::DeserializeOwned,
    {
        let url = format!("{}{}", self.config.base_url, endpoint);
        let response = self
            .execute_with_timeout(|| self.client.put(&url).json(request).send())
            .await?;
        ...
        R: serde::de::DeserializeOwned,
    {
        let url = format!("{}{}", self.config.base_url, endpoint);
        let response = self
            .execute_with_timeout(|| self.client.delete(&url).json(request).send())
            .await?;
        ...
        R: serde::de::DeserializeOwned,
    {
        let url = format!("{}{}", self.config.base_url, endpoint);
        let response = self
            .execute_with_timeout(|| self.client.delete(&url).send())
            .await?;
